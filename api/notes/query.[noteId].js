...
// node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/utils.js
var require_utils = __commonJS({
  "node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/utils.js"(exports, module2) {
...
// node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/request.js
var require_request = __commonJS({
  "node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/request.js"(exports, module2) {
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
    var __hasOwnProp2 = Object.prototype.hasOwnProperty;
...
// node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/response.js
var require_response = __commonJS({
  "node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/response.js"(exports, module2) {
    var __defProp2 = Object.defineProperty;
    var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames2 = Object.getOwnPropertyNames;
    var __hasOwnProp2 = Object.prototype.hasOwnProperty;
...
// node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/index.js
var require_apiRoute = __commonJS({
  "node_modules/.pnpm/@umijs+preset-umi@4.0.47_bhlb3zz73g6okcyvrq75yoihey/node_modules/@umijs/preset-umi/dist/features/apiRoute/index.js"(exports, module2) {
...
// src/.umi/api/notes/query.[noteId].ts
var query_noteId_exports = {};
__export(query_noteId_exports, {
  default: () => query_noteId_default2
});
module.exports = __toCommonJS(query_noteId_exports);
...
// src/api/notes/query.[noteId].ts
async function query_noteId_default(req, res) {
  res.status(400).json({ error: "This API is not implemented yet." });
}

// src/.umi/api/notes/query.[noteId].ts
var import_apiRoute = __toESM(require_apiRoute());
var apiRoutes = [{ "path": "notes/query/[noteId]", "id": "notes/query.[noteId]", "file": "notes/query.[noteId].ts", "absPath": "/notes/query/[noteId]", "__content": "import type { UmiApiRequest, UmiApiResponse } from 'umi';\n\nexport default async function (req: UmiApiRequest, res: UmiApiResponse) {\n  res.status(400).json({ error: 'This API is not implemented yet.' });\n}\n" }, { "path": "notes/add", "id": "notes/add", "file": "notes/add.ts", "absPath": "/notes/add", "__content": "import { PrismaClient } from '@prisma/client';\nimport type { UmiApiRequest, UmiApiResponse } from 'umi';\n\nexport default async function (req: UmiApiRequest, res: UmiApiResponse) {\n  if (req.method === 'POST') {\n    try {\n      const prisma = new PrismaClient();\n\n      const tag = await prisma.tag.create({\n        data: {\n          label: req.body.label,\n        },\n      });\n\n      res.status(201).json({\n        code: 0,\n        data: {\n          id: tag.id,\n        },\n      });\n\n      await prisma.$disconnect();\n    } catch (err) {\n      console.log(err);\n\n      res.status(500).json({\n        code: -1,\n        message: err,\n      });\n    }\n  } else {\n    res.status(405).json({ error: 'Method not allowed' });\n  }\n}\n" }];
var query_noteId_default2 = async (req, res) => {
  ...
  await query_noteId_default(umiReq, umiRes);
};
