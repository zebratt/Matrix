...
// src/.umi/api/notes/[noteId].ts
var noteId_exports = {};
__export(noteId_exports, {
  default: () => noteId_default2
});
module.exports = __toCommonJS(noteId_exports);
...
var noteId_default2 = async (req, res) => {
  ...
  await noteId_default(umiReq, umiRes);
};
